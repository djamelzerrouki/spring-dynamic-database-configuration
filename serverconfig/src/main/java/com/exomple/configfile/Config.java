...
import com.example.SpringBootMultipleDsApplication;
...
public class Config {
	...
	public static void main(String[] args) throws IOException {
		...
		//newMkdirss(FinalName.pathPackage,"Modele_jhdhfk");
		// newMkdirss(FinalName.pathRepository,name);
		newMkdirss(FinalName.pathRepository,"k");

// addingRepository
		addingRepository("k","Employe");
		addingRepository("k","Book");
		addingRepository("k","User");
		addingRepository("k","Service");
		addingRepository("k","Historique");
		addingRepository("k","Dossier");

		creatEntity("k",6);
	 creatConfigDBClass("k");
		//saveParamChanges();
		// WritePropertiesFile("appwrite1", "jdbc:mysql://localhost:3306/datasource3");
		 configPropertiesFile("k");	
	}
